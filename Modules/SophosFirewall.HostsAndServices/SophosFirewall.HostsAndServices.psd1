@{
    ...
    PrivateData          = @{
        PSData = @{
            ...
            ReleaseNotes = 'The seven Import-Sfos* cmdlets now support -WhatIf/-Confirm and skip the individual New-Sfos* calls they would have made. Requires SophosFirewall.Core 1.3.2 or later.'
        }
    }
}
