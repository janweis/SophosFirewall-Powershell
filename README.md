...
management API. Twenty modules ship 654 cmdlets, covering twenty of the API's areas.
...
654 cmdlets in total. Every module follows the same connection model and shares the
